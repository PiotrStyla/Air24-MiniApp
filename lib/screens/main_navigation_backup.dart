...
class _MainNavigationState extends State<MainNavigation> {
  ...
  // _initializeServices method removed - relocated to initState
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ElevatedButton.icon(
                        ...
                        label: Text(TranslationHelper.getString(context, 'myFlights', fallback: 'My Flights')),
                    ...
                    Tooltip(
                      message: TranslationHelper.getString(context, 'faqAndHelp', fallback: 'FAQ & Help'),
                      child: IconButton(
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(TranslationHelper.getString(context, 'myDocuments', fallback: 'My Documents')),
                  style: ElevatedButton.styleFrom(
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(TranslationHelper.getString(context, 'accessibility', fallback: 'Accessibility')),
                  style: ElevatedButton.styleFrom(
  ...
  Widget build(BuildContext context) {
    // Use our TranslationHelper instead of AppLocalizations
