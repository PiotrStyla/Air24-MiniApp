...
for lang_code in language_codes:
    ...
    if os.path.exists(file_path):
        ...
        # Find the formSubmissionError method
        pattern = r'@override\s+String formSubmissionError\(String error\) \{\s+return [^;]+;'
        ...
        if match:
            ...
            # Create new implementation that uses the parameter correctly
            new_impl = f'@override\n  String formSubmissionError(String error) {{\n    return \'{message_text[lang_code]}\' + error + \'{suffix_text[lang_code]}\';'
            ...
            print(f"Updated formSubmissionError in {file_path}")
        else:
            print(f"Could not find formSubmissionError method in {file_path}")
    else:
